...
--------------|-------------------|--------|--------------------|------------------|----------|-----------|-------------------------------
TER ACESSO AO SISTEMA ESTA LOGADO COM LOGIN E SENHA |NOME: RODRIGO GOMES SANTIAGO EMAIL: RODRIGO@GMAIL.COM CPF:12345678601 TEL81988888888| CADASTRAR PACIENTE / NOVO REGISTRO / DADOS DO PACIENTE / SALVAR REGISTRO / REALIZAR CHECK-IN / | PACIENTE CADASTRADO E LOCALIZADO PARA CHECK-IN | PACIENTE CADASTRADO NÃO LOCALIZADO PARA CHECK-IN |REPROVADO| PRINT DA TELA |SISTEMA NÃO LOCALIZA PACIENTE PARA REALIZAR CHECK-IN
