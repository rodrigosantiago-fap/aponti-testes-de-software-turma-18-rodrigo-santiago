...
1. Funcionalidades principais definidas
2. Prazo de entrega estabelecido
3. Time reduzido
...
- Ambiente simulado de testes
- Sistemas Operacionais: Windows, Linux, MacOs, Android, Ios
- Navegadores: Google Chrome, Safari, Edge

5. Recursos e Responsabilidades
- Lider: Organiza e define tarefas acompanha o andamento e define estratégias.
- Analista de testes: Execução dos casos testes e relatar erros e falhas.
...
- Redução dos componentes do time: Ter documentação bem elaborada e informações básicas do sistema bem compartilhada.
